...
def combat_round(att_units, def_units, first_round, options):
    ...
    att_units, options = assign.assign_hits(att_units, def_hits, options["att_riskdirecthit"], options["att_faction"], options,
                                     True)
    ...
    def_units, options = assign.assign_hits(def_units, att_hits, options["def_riskdirecthit"], options["def_faction"], options,
                                     False)
...
def iteration(att_units, def_units, options):
    if not options["ground_combat"]:
        ...
        att_units, def_units, options = antifighter(att_units, def_units, options)
