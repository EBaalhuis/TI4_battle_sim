...
def make_boxes(checkboxes, hidden):
    boxes = {"general": [option_line(checkboxes, hidden, "riskdirecthit", "Risk Direct Hit"),
             ...
             "hidden": [option_line(checkboxes, hidden, "mahact_flagship_hide", "Mahact Flagship Bonus", both=False, enabled=False),
                        option_line(checkboxes, hidden, "", "", "mahact_flagship_hide", "Mahact Flagship Bonus", both=False, enabled=False),
                        option_line(checkboxes, hidden, "naalu_mech_hide", "Naalu Mech Bonus", both=False, enabled=False),
                        option_line(checkboxes, hidden, "", "", "naalu_mech_hide", "Naalu Mech Bonus", both=False, enabled=False),
                        ...
                        option_line(checkboxes, hidden, "naazrokha_supercharge_nekro_hide", "Supercharge", both=False,
                                    enabled=False),
                        option_line(checkboxes, hidden, "", "", "naazrokha_supercharge_nekro_hide", "Supercharge",
                                    both=False, enabled=False),
