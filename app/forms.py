...
class InputForm(FlaskForm):
    ...
    att_mahact_flagship_hide = BooleanField("Mahact Flagship Bonus", default=False)
    def_mahact_flagship_hide = BooleanField("Mahact Flagship Bonus", default=False)
    att_naalu_mech_hide = BooleanField("Naalu Mech Bonus", default=False)
    def_naalu_mech_hide = BooleanField("Naalu Mech Bonus", default=False)
    att_nekro_mech_hide = BooleanField("Nekro Mech Bonus", default=False)
    def_nekro_mech_hide = BooleanField("Nekro Mech Bonus", default=False)
    att_mentak_hero_hide = BooleanField("Mentak Hero", default=False)
    def_mentak_hero_hide = BooleanField("Mentak Hero", default=False)
    ...
    def_naazrokha_supercharge_nekro_hide = BooleanField("Supercharge", default=False)
    att_sardakk_valkyrie_nekro_hide = BooleanField("Valkyrie Particle Weave", default=False)
    def_sardakk_valkyrie_nekro_hide = BooleanField("Valkyrie Particle Weave", default=False)
